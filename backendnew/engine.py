...
def play_game(bot1_path, bot2_path):
    ...
    round_num = 0
    match_log = []  # Store log in memory here

    # Open CSV log file It creates a new file named game_log.csv in the current working directory.If the file already exists, it will be overwritten ("w" = write mode).
    ...
    with open("game_log.csv", "w", newline="") as f: 
        ...
        while scores["bot1"] < MAX_SCORE and scores["bot2"] < MAX_SCORE:
            ...
            while True:
                ...
                "bot1_action": move1,
                "bot2_action": move2,
                "score_bot1": scores["bot1"],
                "score_bot2": scores["bot2"]
                })
